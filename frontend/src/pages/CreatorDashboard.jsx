...
const CreatorDashboard = () => {
    const tasks = [
        { title: 'Upload Content', icon: Upload, desc: 'Add video, audio or reading material', iconColor: 'text-cyan-600', bgColor: 'bg-cyan-50' },
        { title: 'Edit Content', icon: Edit3, desc: 'Update existing platform assets', iconColor: 'text-lime-600', bgColor: 'bg-lime-50' },
        { title: 'Quality Review', icon: ShieldAlert, desc: 'Ensure content meets standards', iconColor: 'text-fuchsia-600', bgColor: 'bg-fuchsia-50' },
        { title: 'Asset Library', icon: Image, desc: 'Manage your uploaded media', iconColor: 'text-orange-600', bgColor: 'bg-orange-50' },
    ];
