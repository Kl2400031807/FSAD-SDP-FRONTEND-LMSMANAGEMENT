...
const InstructorDashboard = () => {
    const actions = [
        { title: 'My Courses', icon: Layout, desc: 'Manage your existing courses', iconColor: 'text-indigo-600', bgColor: 'bg-indigo-50', path: '/my-courses' },
        ...
        { title: 'Grade Assignments', icon: CheckCircle, desc: 'Review student submissions', iconColor: 'text-orange-600', bgColor: 'bg-orange-50', path: '/grade-assignments' },
