...
const AdminDashboard = () => {
    const stats = [
        { title: 'Manage Users', icon: Users, desc: 'Add, edit or remove platform users', color: 'bg-blue-600', iconColor: 'text-blue-600', bgColor: 'bg-blue-50', path: '/admin/users' },
        { title: 'Manage Courses', icon: BookOpen, desc: 'Approve and monitor course content', color: 'bg-emerald-600', iconColor: 'text-emerald-600', bgColor: 'bg-emerald-50', path: '/admin/courses' },
        { title: 'Platform Reports', icon: BarChart3, desc: 'Financial and activity analytics', color: 'bg-amber-600', iconColor: 'text-amber-600', bgColor: 'bg-amber-50', path: '/admin/reports' },
        { title: 'System Settings', icon: ShieldCheck, desc: 'Configure platform parameters', color: 'bg-slate-600', iconColor: 'text-slate-600', bgColor: 'bg-slate-50', path: '/admin/settings' },
    ];
